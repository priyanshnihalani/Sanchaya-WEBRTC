class WebRTCConnection {
    ...
    async fallbackToTURN() {
        console.warn("Switching to TURN relay mode");
    ...
    setupPeerEvents() {
        ...
        this.pc.oniceconnectionstatechange = () => {
            ...
            if (state === "failed") {
                console.warn("ICE failed. Falling back to TURN.");
                this.fallbackToTURN();
            }

            if (state === "closed") {
                this.failTransfer("connection-closed");
            }
        };
    }
