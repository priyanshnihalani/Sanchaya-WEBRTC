...
export function WebRTCProvider({ children }) {
    ...
    function createConnection(files) {
        const connection = new WebRTCConnection(socket, files, setCompleted, setChunkData, writableRef, updatePercent);
    ...
    return (
        <WebRTCContext.Provider value={{ instance, createConnection, completed, writableRef, percentMap, updatePercent, chunkData, currentFileRef }}>
            {children}
