          ...
          <div className="layout-content-container flex flex-col max-w-[1024px] flex-1">
            <div className="@container">
              <div className="@[480px]:p-4">
                <div
                  className="flex min-h-[480px] aspect-retro flex-col gap-6 bg-cover bg-center bg-no-repeat @[480px]:gap-8 @[480px]:rounded-xl items-center justify-center p-4"
                  style={{
                    
                    backgroundImage:
                      "linear-gradient(rgba(0, 0, 0, 0.1) 0%, rgba(0, 0, 0, 0.4) 100%), url('https://lh3.googleusercontent.com/aida-public/AB6AXuD5nCDbD-HNQXfXHbjV9Z4Y3bueApIP_HsGAoplIGjBZIiGQvS2y9vR_mY19foPFeHCLAe31zTdL-HgVF0Q5Rjy-VS5tvSxSuQwlrUGUjDGY_gms-WCX_dRI1xP9ktcJU2JqwRG-_-y5k4oLoFuvWtEA3oj3ABYWuH8kNB-Hx7p8adMnwMbMgVnl1BcGv8dPFTf9dIzIT_VDK-f6Z57Xn-JXitGOjfHyxfYoxf6nCr1gieEqmu-Y3MaFYMd3LDEAmLWFN0Uh0TZ9eA=s4096')",
                  }}
                >
                  ...
                  <button onClick={() => navigate('/send')} className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-xl h-10 px-4 @[480px]:h-12 @[480px]:px-5 bg-[#3d98f4] text-white text-sm font-bold leading-normal tracking-[0.015em] @[480px]:text-base @[480px]:font-bold @[480px]:leading-normal @[480px]:tracking-[0.015em]">
            ...
            <div className="flex flex-col gap-10 px-4 py-10 @container">
              <div className="flex flex-col gap-4">
                ...
                <p className="text-[#111418] text-base font-normal leading-normal max-w-[720px]">
                  FileDrop is the easiest way to send files of any size to anyone, anywhere. Whether you're sending a single file or a large collection, FileDrop makes it simple
                  and secure.
                </p>
              </div>
                ...
                <div className="flex flex-1 gap-3 rounded-lg border border-[#dbe0e6] bg-white p-4 flex-col">
                  <div className="text-[#111418]">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                      <path d="M160,40A88.09,88.09,0,0,0,81.29,88.67A64,64,0,1,0,72,216h88a88,88,0,0,0,0-176Zm0,160H72a48,48,0,0,1,0-96c1.1,0,2.2,0,3.29.11A88,88,0,0,0,72,128a8,8,0,0,0,16,0,72,72,0,1,1,72,72Z"></path>
                    </svg>
                  </div>
